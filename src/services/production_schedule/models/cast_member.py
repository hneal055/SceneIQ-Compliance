...
# The CastMember dataclass — one cast member on a production.
...
@dataclass
class CastMember:
    # Character name as it appears in the script — e.g. "DETECTIVE MARSH".
    character_name: str
    ...
    # Real-world actor name. Optional — many breakdowns leave this blank.
